...
describe('ProtocolService', () => {
  ...
  describe('searchProtocols', () => {
    ...
    it('should filter protocols based on search term', async () => {
      const result = await protocolService.searchProtocols({ chain: 'eth', searchTerm: 'Aave' });
    ...
    it('should return empty array when no matches are found', async () => {
      const result = await protocolService.searchProtocols({ chain: 'eth', searchTerm: 'NonExistentProtocol' });
