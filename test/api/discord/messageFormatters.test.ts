...
import { TextMessageBuilder, EmbedMessageBuilder, DiscordColors } from '../../../src/api/discord/messageFormatters';
...
describe('MessageFormatters', () => {
  ...
  describe('EmbedMessageBuilder', () => {
    it('should build an embed message using discord.js EmbedBuilder', () => {
      ...
      expect(mockSetDescription).toHaveBeenCalledWith('This is a test description');
      expect(mockAddFields).toHaveBeenCalledWith({ name: 'Field 1', value: 'Value 1', inline: undefined });
    ...
    it('should chain methods correctly', () => {
      // Act
      const builder = new EmbedMessageBuilder()
        .addTitle('Test Title');
