...
describe('ping command', () => {
  ...
  it('should indicate that the application is running', () => {
    ...
    expect(ConsoleMock.log).toHaveBeenNthCalledWith(1, '🔥 defi-stuff is running!');
    expect(ConsoleMock.log).toHaveBeenNthCalledWith(2, '✅ Environment is properly configured');
