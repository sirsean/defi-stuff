import { discordService, DiscordColors, MessageBuilder } from '../api/discord/index.js';
...
async function sendDiscordMessages() {
  try {
    ...
    const embedMessage = discordService.createEmbedMessage()
      ...
      .addDescription('A significant change has been detected in one of your tracked protocols')
      .addField('Protocol', 'UniswapV3', true)
      .addField('Change', '+15.4%', true)
      .addField('Current Value', '$584.25', true)
      .addField('Details', 'The protocol has experienced a significant increase in the last 24 hours.')
