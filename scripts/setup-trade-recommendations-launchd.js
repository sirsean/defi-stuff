...
try {
  ...
  console.log("Job is loaded and scheduled to run every hour");
  console.log(result);
} catch (error) {
  console.error(
...
console.log(
  "Setup complete! The trade-recommendation command will run automatically every hour.",
);
console.log(
  `Logs will be written to: ${LOGS_DIR}/trade-recommendations-output.log and ${LOGS_DIR}/trade-recommendations-error.log`,
);
