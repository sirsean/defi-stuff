...
try {
  ...
  console.log("Running the trade-recommendation job now...");
  execSync("launchctl start com.defi-stuff.trade-recommendations");
  ...
  console.log("tail -f logs/trade-recommendations-output.log");
} catch (error) {
